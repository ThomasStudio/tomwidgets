...
from tomwidgets.model import Emoji
...
def main():
    ...
    kvs1 = ClassUtil.getValues(Emoji.Flat)
    kvs2 = ClassUtil.getValues(Emoji.Position)
    kvs3 = ClassUtil.getValues(Emoji)

    lineCount = 16
    items = []

    for kvs in [kvs1, kvs2, kvs3]:
